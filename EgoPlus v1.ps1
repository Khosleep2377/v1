...
$guid = "154c0832-a54e-4dce-972e-4e8d8486939c"

# Rename plan
Run-Safe "powercfg /changename $guid Zeacross Zeacross diwa"
...
Run-Safe "powercfg /change -standby-timeout-ac 0"
Run-Safe "powercfg /change -hibernate-timeout-ac 0"
Run-Safe "powercfg /change -monitor-timeout-ac 0"
Run-Safe "powercfg /change -disk-timeout-ac 0"
...
Run-Safe "powercfg /setacvalueindex $guid SUB_USB USBSELECTSUSPEND 0"
Run-Safe "powercfg /setacvalueindex $guid SUB_PCIEXPRESS ASPM 0"
...
Run-Safe 'reg add "HKLM\SYSTEM\CurrentControlSet\Control\Power\PowerThrottling" /v PowerThrottlingOff /t REG_DWORD /d 1 /f'
...
Run-Safe "powercfg /setactive $guid"
